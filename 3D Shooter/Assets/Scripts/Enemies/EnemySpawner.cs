...
public class EnemySpawner : MonoBehaviour
{
    ...
    [Tooltip("The effect prefab to use while spawning")]
    ...
    public void Spawn()
    {
        if (prefab != null)
        {
            ...
            GameObject.Instantiate(prefab, spawnLocation, Quaternion.identity, null);
            if (sfx != null)
            {
                GameObject.Instantiate(sfx, spawnLocation, Quaternion.identity, null);
            }
        }
    }
