...
public class GameManager : MonoBehaviour
{
    ...
    [Tooltip("Is the current level a kill based level?")]
    public bool killBased = false;
    [Tooltip("Amount of kills required to progress")]
    public int killsRequired = 0;
    
    public static int currentKills = 0;

    [Tooltip("Is the current level a time based level?")]
    public bool timeBased = false;
    [Tooltip("Time in Seconds to survive")]
    public int timeSecondsRequired = 0;
    ...
    {
        float currentTime = timeSecondsRequired;
    ...
    public void LevelCleared()
    {
        ...
        if (UIManager.instance != null)
        {
            // pause the game without bringing up the pause screen
            Time.timeScale = 0;
    ...
    public void AddKill()
    {
        currentKills++;
        UpdateUIElements();
        if (killBased && currentKills >= killsRequired)
        {
            LevelCleared();
        }
    }
